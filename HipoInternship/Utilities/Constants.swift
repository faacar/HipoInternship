...
//  Hipo
//
//  Created by Ahmet Acar on 26.03.2021.
//
...
enum HipoColors {
    static let cellArrow = UIColor(red: 0.2, green: 0.2, blue: 0.2, alpha: 1.0)
    static let cellBorderColor = UIColor(red: 0.9176470588235294, green: 0.9176470588235294, blue: 0.9294117647058824, alpha: 1.0)
